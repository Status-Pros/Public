# This script will export all groups and their assiciated members to a CSV file
...
#// Set CSV file name 
$CSVFile = "C:\support\AD_Groups"+$DateTime+".csv" 
...
foreach ($ADGroup in $ADGroups) { 
    ...
    $MembersArr = Get-ADGroup -filter {Name -eq $ADGroup.Name} | Get-ADGroupMember | select samAccountName, Name, objectClass, distinguishedName 
    if ($MembersArr) {  
